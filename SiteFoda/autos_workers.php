...
<body>
    ...
    <div class="conteudo conteudo-centralizado">
        ...
        <form method="post" id="languageForm" onsubmit="return validateForm()">
            ...
            <br>
            <input type="checkbox" name="languages[]" id="JavaScript" value="Ar Condicionado">
            <label for="JavaScript">JavaScript</label>
            <br>
            <input type="checkbox" name="languages[]" id="Python" value="Auto elétrico">
            <label for="Python">Python</label>
            <br>
            <input type="checkbox" name="languages[]" id="C#" value="Borracharia">
            <label for="C#">C#</label>
            <br>
            <input type="checkbox" name="languages[]" id="Java" value="Funilaria Automotiva">
            <label for="Java">Java</label>
            <br>
            <input type="checkbox" name="languages[]" id="PHP" value="Higienização">
            <label for="PHP">PHP</label>
            <br>
            <input type="checkbox" name="languages[]" id="Ruby" value="Insulfilm">
            <label for="Ruby">Ruby</label>
            <br>
            <input type="checkbox" name="languages[]" id="Swift" value="Martelinho de Ouro">
            <label for="Swift">Swift</label>
            <br>
            <input type="checkbox" name="languages[]" id="C++" value="Mecanica em geral">
            <label for="C++">C++</label>
            <br>
            <input type="checkbox" name="languages[]" id="TypeScript" value="Pintura em geral">
            <label for="TypeScript">TypeScript</label>
            <br>
            <input type="checkbox" name="languages[]" id="SQL" value="Som de Automoveis">
